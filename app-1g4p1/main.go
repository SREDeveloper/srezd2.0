...
import (
	...
	"strconv"
	"time"
	"github.com/srezd/app-1g4p1/blockchain"
	"github.com/srezd/app-1g4p1/tcpkeepalive"
)
...
func main() {
	...
	fSetup := blockchain.FabricSetup{
		...
		// Channel parameters
		ChannelID:     "srezd",
		//ChannelConfig: os.Getenv("GOPATH") + "/src/github.com/srezd/app-1g4p1/fixtures/artifacts/srezd.channel.tx",

		// Chaincode parameters
		ChainCodeID:     "app-1g4",
		ChaincodeGoPath: os.Getenv("GOPATH"),
		ChaincodePath:   "github.com/srezd/app-1g4p1/chaincode/",
		Org_now:         "org4",
	...
	listen_sock, err := net.Listen("tcp", ":21111")
	if err != nil {
