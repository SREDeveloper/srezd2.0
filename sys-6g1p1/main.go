...
import (
	...
	"strconv"
	"time"
	"github.com/srezd/sys-6g1p1/blockchain"
	"github.com/srezd/sys-6g1p1/tcpkeepalive"
)
/*
...
func main() {
	...
	fSetup := blockchain.FabricSetup{
		...
		// Channel parameters
		ChannelID:     "srezd",
		ChannelConfig: os.Getenv("GOPATH") + "/src/github.com/srezd/sys-6g1p1/fixtures/artifacts/srezd.channel.tx",

		// Chaincode parameters
		ChainCodeID:     "sys-6g1",
		ChaincodeGoPath: os.Getenv("GOPATH"),
		ChaincodePath:   "github.com/srezd/sys-6g1p1/chaincode/",
		Org_now:         "org1",
		Org2:         "org2",
		Org3:         "org3",
		Org4:         "org4",
	...
	listen_sock, err := net.Listen("tcp", ":27777")
	if err != nil {
